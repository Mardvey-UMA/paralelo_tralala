...
int main(int argc, char **argv) {
    ...
    int Size;  // Будет содержать общее число процессов
    MPI_Comm_size(MPI_COMM_WORLD, &Size);
    
    // Получение ранга (номера) текущего процесса
    ...
    MPI_Sendrecv(
        &a,                // Отправляем те же данные (a)
        1, 
        MPI_DOUBLE,
        Prev,              // Теперь отправляем предыдущему процессу
        5,
